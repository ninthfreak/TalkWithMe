    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                f"is a banker.\n\n"
                f"Keep every fact. Keep each line about one person, and "
                f"keep the name in brackets at the start. Leave a note "
                f"alone when it has nothing to merge with.\n\n"
...
async def plan(persona: Persona) -> CondensePlan:
    ...
    condensed = [row.stored() for row in rows]
