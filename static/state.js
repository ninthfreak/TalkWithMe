...
const pfForgetBtn = document.getElementById("pf-memories-forget");
const pfForgetOverlay = document.getElementById("pf-forget-overlay");
const pfForgetWho = document.getElementById("pf-forget-who");
const pfForgetStatus = document.getElementById("pf-forget-status");
const pfForgetList = document.getElementById("pf-forget-list");
const pfForgetUntagged = document.getElementById("pf-forget-untagged");
const pfForgetError = document.getElementById("pf-forget-error");
const pfForgetClose = document.getElementById("pf-forget-close");
const pfForgetCancel = document.getElementById("pf-forget-cancel");
const pfForgetApply = document.getElementById("pf-forget-apply");
const pfCondenseBtn = document.getElementById("pf-memories-condense");
const pfCondenseOverlay = document.getElementById("pf-condense-overlay");
const pfCondenseStatus = document.getElementById("pf-condense-status");
const pfCondenseDiff = document.getElementById("pf-condense-diff");
const pfCondenseBefore = document.getElementById("pf-condense-before");
const pfCondenseAfter = document.getElementById("pf-condense-after");
const pfCondenseError = document.getElementById("pf-condense-error");
const pfCondenseClose = document.getElementById("pf-condense-close");
const pfCondenseCancel = document.getElementById("pf-condense-cancel");
const pfCondenseApply = document.getElementById("pf-condense-apply");
