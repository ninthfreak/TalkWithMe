...
async function openPersonaForm(name) {
    ...
    if (name) {
        ...
        try {
            ...
            // Relative to the room; "match" means simply follow it.
            pfLengthBias.value        = p.length_bias || "match";
...
async function submitPersonaForm(e) {
    ...
    form.append("length_bias", pfLengthBias.value || "match");
